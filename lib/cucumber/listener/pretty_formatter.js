var PrettyFormatter = function(options) {
  ...
  self._handleBeforeScenarioOrScenarioOutlineEvent = function _handleBeforeScenarioOrScenarioOutlineEvent(type) {
    return function (event, callback) {
      var scenario = event.getPayloadItem(type);
  ...
  self.handleBeforeScenarioEvent = self._handleBeforeScenarioOrScenarioOutlineEvent('scenario');

  self.handleBeforeScenarioOutlineEvent = self._handleBeforeScenarioOrScenarioOutlineEvent('scenarioOutline');
  ...
  self.handleAfterScenarioOutlineEvent = self.handleAfterScenarioEvent;
